...
from data.records import Records, records_blueprint
from data.news import News, news_blueprint
from data.users import User, user_blueprint
from data.maps import Maps, maps_blueprint
...
@app.route('/maps.rar', methods=['GET', 'POST'])
def download_zip():
    return send_file('static/maps.rar')
